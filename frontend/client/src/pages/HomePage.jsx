          ...
          <div className="mb-6 bg-red-50 border-l-4 border-red-500 text-red-700 p-4 rounded">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm mt-1">{booksError}</p>
                <div className="mt-3 flex space-x-2">
                  <button
                    onClick={() => fetchBooks()}
                    disabled={booksLoading}
                    className="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                  >
                    {booksLoading ? (
                      <>
                  ...
                  <p className="text-xs text-red-600 mt-2 self-center">
                    Make sure the backend server is running at {import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL.replace('/api', '') : 'http://localhost:3000'}
                  </p>
                </div>
              </div>
            </div>
